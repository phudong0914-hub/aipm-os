const DATA_PAYLOAD = {
  ...
  "steps": [
    ...
    },
    {
      ...
      "stageName": "Giai đoạn chuẩn bị dự án",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "stepName": "Báo cáo kết quả thẩm tra nếu có theo yêu cầu của cơ quan chuyên môn về xây dựng Văn bản ý kiến của cơ quanCông an về giải phápphòng cháy,chữa cháygiai đoạnthiết kế cơ sở điều",
      "gate": "G5",
      "icon": "📐",
      "input": [],
      "tasks": [
        "Báo cáo kết quả thẩm tra nếu có theo yêu cầu của cơ quan chuyên môn về xây dựng Văn bản ý kiến của cơ quanCông an về giải phápphòng cháy,chữa cháygiai đoạnthiết kế cơ sở điều"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn chuẩn bị dự án",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "stepName": "chỉnh(n ếucó) ( theoLu ậtPCCC n ăm2024 đã bỏ thủ tụcnày,tuynhiênth ực tế có một số DA vẫnth ực hiện xin ý kiến )",
      "gate": "G5",
      "icon": "🔥",
      "input": [],
      "tasks": [
        "chỉnh(n ếucó) ( theoLu ậtPCCC n ăm2024 đã bỏ thủ tụcnày,tuynhiênth ực tế có một số DA vẫnth ực hiện xin ý kiến )"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn chuẩn bị dự án",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "stepName": "Báo cáo thẩm định nội bộ của Chủ đầu tư về việc điều chỉnh dự án đầu tư xây dựng công trình Kếtqu ả thẩm định của cơ quan chuyên môn về xây dựng (nếucótheoquy định tạikho ản 2 Điều19 Nghị định số 59/2021/NĐ-CP )",
      "gate": "G5",
      "icon": "📌",
      "input": [],
      "tasks": [
        "Báo cáo thẩm định nội bộ của Chủ đầu tư về việc điều chỉnh dự án đầu tư xây dựng công trình Kếtqu ả thẩm định của cơ quan chuyên môn về xây dựng (nếucótheoquy định tạikho ản 2 Điều19 Nghị định số 59/2021/NĐ-CP )"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn chuẩn bị dự án",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "stepName": "Quyết định phê duyệt điều chỉnh dự án đầu tư xây dựng Cáctàili ệukháccóliênquantronggiai đoạnchu ẩn bịđầ u tư xây dựng(l ậpdanh m ụcchiti ết kèm theo)",
      "gate": "G5",
      "icon": "📌",
      "input": [],
      "tasks": [
        "Quyết định phê duyệt điều chỉnh dự án đầu tư xây dựng Cáctàili ệukháccóliênquantronggiai đoạnchu ẩn bịđầ u tư xây dựng(l ậpdanh m ụcchiti ết kèm theo)"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn chuẩn bị dự án",
      "group": "Vốn bố trí cho dự án giai đoạn chuẩn bị đầu tư",
      "stepName": "Quyết định/Thông báo bố trí vốn hằng năm Nhiệm vụ thiết kếđượ cChủ đầu tư phêduy ệt;cácý kiến củacác cơ quan liên quan (nếu có) về Nhiệm vụ thiết kế (liệt kê chi tiết)",
      "gate": "G7",
      "icon": "💰",
      "input": [],
      "tasks": [
        "Quyết định/Thông báo bố trí vốn hằng năm Nhiệm vụ thiết kếđượ cChủ đầu tư phêduy ệt;cácý kiến củacác cơ quan liên quan (nếu có) về Nhiệm vụ thiết kế (liệt kê chi tiết)"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Văn bản thông báo chấp thuận nghiệm thu kết quả khảo sát xây dựng. Thiết kế kỹ thuật(tr ường hợpthiết kế 03 bước)/thiết kế bản vẽ thicông(tr ường hợpthiết kế 02 bước) và dự toán xây dựng công trình tương ứng",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Văn bản thông báo chấp thuận nghiệm thu kết quả khảo sát xây dựng. Thiết kế kỹ thuật(tr ường hợpthiết kế 03 bước)/thiết kế bản vẽ thicông(tr ường hợpthiết kế 02 bước) và dự toán xây dựng công trình tương ứng"
      ],
      "output": [
        "Văn bản / xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Kết quả thẩm định dự toán của Chủ đầu tư/Người quyết định đầu tư Hồ sơ thiết kế đãch ỉnh sửa,hoànthi ệnsauthẩm định (gồmthuy ếtminhthiết kế, bảntính;các b ản vẽ",
      "gate": "G5",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Kết quả thẩm định dự toán của Chủ đầu tư/Người quyết định đầu tư Hồ sơ thiết kế đãch ỉnh sửa,hoànthi ệnsauthẩm định (gồmthuy ếtminhthiết kế, bảntính;các b ản vẽ"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Tờ trình thẩm định Báo cáo k ếtqu ả thẩmtrathiết kế (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, l ợiích c ộng đồng )",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Tờ trình thẩm định Báo cáo k ếtqu ả thẩmtrathiết kế (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, l ợiích c ộng đồng )"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Kết quả thẩm định thiết kế PCCC của cơ quan Công an Ýki ến của cơ quan chuyên môn về bảo vệ môitr ường đối vớicông trình,thi ết bị xử lý nướcth ải tại chỗ, thiết bị thu gom và lưu chứa tạm thời chất thải (nếu có)",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Kết quả thẩm định thiết kế PCCC của cơ quan Công an Ýki ến của cơ quan chuyên môn về bảo vệ môitr ường đối vớicông trình,thi ết bị xử lý nướcth ải tại chỗ, thiết bị thu gom và lưu chứa tạm thời chất thải (nếu có)"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Thiết kế bản vẽ thi công (trường hợp thiết kế 03 bước) và dự toán xây dựng công trình tương ứng Báo cáo k ếtqu ả thẩmtrathiết kế (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, l ợiích c ộng đồng )",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Thiết kế bản vẽ thi công (trường hợp thiết kế 03 bước) và dự toán xây dựng công trình tương ứng Báo cáo k ếtqu ả thẩmtrathiết kế (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, l ợiích c ộng đồng )"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Thiết kế, dự toán điều chỉnh (nếu có) Tờ trình thẩm định (trường hợpcóthay đổi vềđị ach ấtcông trình, t ảitr ọngthiết kế,gi ảipháp k ết cấu,",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Thiết kế, dự toán điều chỉnh (nếu có) Tờ trình thẩm định (trường hợpcóthay đổi vềđị ach ấtcông trình, t ảitr ọngthiết kế,gi ảipháp k ết cấu,"
      ],
      "output": [
        "Tờ trình"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "vậtli ệu của kết cấuch ịu lực,bi ệnpháp t ổ chứcthicông ảnh hưởng đếnantoànch ịu lực củacông trình ) Báo cáo k ếtqu ả thẩmtrathiết kế điều chỉnh (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, lợi ích cộng đồng)",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "vậtli ệu của kết cấuch ịu lực,bi ệnpháp t ổ chứcthicông ảnh hưởng đếnantoànch ịu lực củacông trình ) Báo cáo k ếtqu ả thẩmtrathiết kế điều chỉnh (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, lợi ích cộng đồng)"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Kết quả thẩm định dự toán điều chỉnh của Chủ đầu tư/Người quyết định đầu tư Hồ sơ thiết kế điều chỉnh đãch ỉnh sửa,hoànthi ệnsauthẩm định (gồmthuy ếtminhthiết kế, bảntính;",
      "gate": "G5",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Kết quả thẩm định dự toán điều chỉnh của Chủ đầu tư/Người quyết định đầu tư Hồ sơ thiết kế điều chỉnh đãch ỉnh sửa,hoànthi ệnsauthẩm định (gồmthuy ếtminhthiết kế, bảntính;"
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Hồ sơ dự toán điều chỉnh đã chỉnh sửa, hoàn thiện sau thẩm định Chấpthu ận củaNg ườiquy ết định đầu tư (trường hợp việc điều chỉnhlàm v ượt dự toán đãphêduy ệt",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Hồ sơ dự toán điều chỉnh đã chỉnh sửa, hoàn thiện sau thẩm định Chấpthu ận củaNg ườiquy ết định đầu tư (trường hợp việc điều chỉnhlàm v ượt dự toán đãphêduy ệt"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "stepName": "Kết quả thẩm định thiết kế PCCC điều chỉnh của cơ quan Công an (nếu có) Ýki ến của cơ quan chuyên môn về bảo vệ môitr ường đối vớicông trình,thi ết bị xử lý nướcth ải tại chỗ, thiết bị thu gom và lưu chứa tạm thời chất thải (nếu có)",
      "gate": "G9",
      "icon": "📍",
      "input": [],
      "tasks": [
        "Kết quả thẩm định thiết kế PCCC điều chỉnh của cơ quan Công an (nếu có) Ýki ến của cơ quan chuyên môn về bảo vệ môitr ường đối vớicông trình,thi ết bị xử lý nướcth ải tại chỗ, thiết bị thu gom và lưu chứa tạm thời chất thải (nếu có)"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Lựa chọn nhà thầu",
      "stepName": "Chỉ định thầu rút gọn Dự toángóith ầu đượcChủ đầu tư xác định (nếucótrongtr ường hợp đãcó d ự toánxây d ựngcông trình ) Văn bản đề nghị thamgiagóith ầu củaNhàth ầu (kèmtheotàili ệuch ứngminh điềuki ện năng lực của tổ chức và cá nhân theo quy định )",
      "gate": "G10",
      "icon": "🧮",
      "input": [],
      "tasks": [
        "Chỉ định thầu rút gọn Dự toángóith ầu đượcChủ đầu tư xác định (nếucótrongtr ường hợp đãcó d ự toánxây d ựngcông trình ) Văn bản đề nghị thamgiagóith ầu củaNhàth ầu (kèmtheotàili ệuch ứngminh điềuki ện năng lực của tổ chức và cá nhân theo quy định )"
      ],
      "output": [
        "Văn bản / xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Lựa chọn nhà thầu",
      "stepName": "Văn bản gửi Nhà thầu đề nghị lập Hồ sơ đề xuất Hồ sơđề xuất củaNhàth ầu (bao gồm cả tàili ệuch ứngminh điềuki ện năng lực của tổ chứcvàcá nhân theo quy định )",
      "gate": "G10",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Văn bản gửi Nhà thầu đề nghị lập Hồ sơ đề xuất Hồ sơđề xuất củaNhàth ầu (bao gồm cả tàili ệuch ứngminh điềuki ện năng lực của tổ chứcvàcá nhân theo quy định )"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Lựa chọn nhà thầu",
      "stepName": "Quyết định phê duyệt/Văn bản chấp thuận danh sách nhà thầu đáp ứng về kỹ thuật. Thôngbáodanhsáchnhàth ầu đáp ứng kỹ thuật tới tất cả cácnhàth ầu, mờinhàth ầu đến mở hồ sơđề xuất tài chính.",
      "gate": "G10",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Quyết định phê duyệt/Văn bản chấp thuận danh sách nhà thầu đáp ứng về kỹ thuật. Thôngbáodanhsáchnhàth ầu đáp ứng kỹ thuật tới tất cả cácnhàth ầu, mờinhàth ầu đến mở hồ sơđề xuất tài chính."
      ],
      "output": [
        "Quyết định / văn bản phê duyệt tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Lựa chọn nhà thầu",
      "stepName": "Tài liệu đăng tải thông tin mời thầu Pháthành h ồ sơ mờith ầu(Danhsáchho ặcbiên b ảngiaonh ận,phi ếuthucácnhàth ầumua h ồ sơ mời thầu đến trước thời điểm đóng thầu)",
      "gate": "G10",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Tài liệu đăng tải thông tin mời thầu Pháthành h ồ sơ mờith ầu(Danhsáchho ặcbiên b ảngiaonh ận,phi ếuthucácnhàth ầumua h ồ sơ mời thầu đến trước thời điểm đóng thầu)"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "stepName": "Hợp đồng CácPh ụ lục Hợp đồng nếucó ( điều chỉnh, bổ sungkh ối lượng, nộidungcôngvi ệc;ti ến độ;giá Hợp đồng; các điều khoản Hợp đồng)",
      "gate": "G11",
      "icon": "📑",
      "input": [],
      "tasks": [
        "Hợp đồng CácPh ụ lục Hợp đồng nếucó ( điều chỉnh, bổ sungkh ối lượng, nộidungcôngvi ệc;ti ến độ;giá Hợp đồng; các điều khoản Hợp đồng)"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "stepName": "Văn bản của Chủ đầu tư giao Nhà thầu thực hiện bổ sung nội dung công việc Văn bản đề xuất củaNhàth ầu về tiến độ,giá H ợp đồng điều chỉnh (kèmtheobi ểugiáchiti ết đề xuất, tài liệu chứng minh đơn giá đề xuất )",
      "gate": "G11",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Văn bản của Chủ đầu tư giao Nhà thầu thực hiện bổ sung nội dung công việc Văn bản đề xuất củaNhàth ầu về tiến độ,giá H ợp đồng điều chỉnh (kèmtheobi ểugiáchiti ết đề xuất, tài liệu chứng minh đơn giá đề xuất )"
      ],
      "output": [
        "Văn bản / xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "stepName": "Biên bản thương thảo điều chỉnh Hợp đồng Văn bảnchấp thuận củaNg ườiquy ết định đầu tư trongtr ường hợp:(i) B ổ sungkh ối lượngphátsinh",
      "gate": "G11",
      "icon": "📑",
      "input": [],
      "tasks": [
        "Biên bản thương thảo điều chỉnh Hợp đồng Văn bảnchấp thuận củaNg ườiquy ết định đầu tư trongtr ường hợp:(i) B ổ sungkh ối lượngphátsinh"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "stepName": "ngoàiph ạmvicôngvi ệc củagóith ầu;ho ặc(ii) V ượtgiágóith ầuho ặc dự toángóith ầu đượcphê duyệt; hoặc (iii) Trường hợp điều chỉnh tiến độ làm kéo dài tiến độ thực hiện hợp đồng",
      "gate": "G11",
      "icon": "🧮",
      "input": [],
      "tasks": [
        "ngoàiph ạmvicôngvi ệc củagóith ầu;ho ặc(ii) V ượtgiágóith ầuho ặc dự toángóith ầu đượcphê duyệt; hoặc (iii) Trường hợp điều chỉnh tiến độ làm kéo dài tiến độ thực hiện hợp đồng"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Các công việc tư vấn khác Biên bảnbàngiao s ảnph ẩm tư vấn(h ồ sơ thiết kế, dự toán/báo cáo k ếtqu ả thẩmtra/Báo cáocôngtác giám sát,…)",
      "gate": "G9",
      "icon": "📐",
      "input": [],
      "tasks": [
        "Các công việc tư vấn khác Biên bảnbàngiao s ảnph ẩm tư vấn(h ồ sơ thiết kế, dự toán/báo cáo k ếtqu ả thẩmtra/Báo cáocôngtác giám sát,…)"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stepName": "Công tác tạm ứng, thanh toán, quyết toán Bảng tổng hợp lũy kế giátr ị giảingân củatoàn b ộ Dự án từngthángtheo t ừngkho ản mụcchiphí/gói thầu/phần việc",
      "gate": "G14",
      "icon": "🧾",
      "input": [],
      "tasks": [
        "Công tác tạm ứng, thanh toán, quyết toán Bảng tổng hợp lũy kế giátr ị giảingân củatoàn b ộ Dự án từngthángtheo t ừngkho ản mụcchiphí/gói thầu/phần việc"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "stepName": "Hồ sơ tạm ứng (từng đợt) Văn bảnchấp thuận của cấpcóthẩmquy ền về việcchophép t ạm ứng vượtquá30%giátr ị hợp đồng (bao gồm cả dự phòng nếu có)",
      "gate": "G11",
      "icon": "📑",
      "input": [],
      "tasks": [
        "Hồ sơ tạm ứng (từng đợt) Văn bảnchấp thuận của cấpcóthẩmquy ền về việcchophép t ạm ứng vượtquá30%giátr ị hợp đồng (bao gồm cả dự phòng nếu có)"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "stepName": "Bảo lãnh thực hiện Hợp đồng Văn bảncam k ết củaNgânhàng về việcch ỉđượ cphépkh ấutr ừ vàthanhtoánchocáccôngvi ệcliên quan đến dự án (nếu Hợp đồng có quy định )",
      "gate": "G11",
      "icon": "📑",
      "input": [],
      "tasks": [
        "Bảo lãnh thực hiện Hợp đồng Văn bảncam k ết củaNgânhàng về việcch ỉđượ cphépkh ấutr ừ vàthanhtoánchocáccôngvi ệcliên quan đến dự án (nếu Hợp đồng có quy định )"
      ],
      "output": [
        "Văn bản / xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "stepName": "Hồ sơ thanh toán (từng đợt) Văn bản đề nghị thanhtoán c ủaNhàth ầukèmtheoBiên b ảngiaonh ận hồ sơ (liệtkêchiti ếtdanh m ục hồ sơ )",
      "gate": "G14",
      "icon": "🧾",
      "input": [],
      "tasks": [
        "Hồ sơ thanh toán (từng đợt) Văn bản đề nghị thanhtoán c ủaNhàth ầukèmtheoBiên b ảngiaonh ận hồ sơ (liệtkêchiti ếtdanh m ục hồ sơ )"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "stepName": "Hồ sơ chất lượng (đề cập tại Mục 8 Phần II trên đây ) Biên bảnnghi ệmthukh ối lượngcôngvi ệchoànthành t ương ứng vớigiai đoạnthànhtoán đã được đại",
      "gate": "G12",
      "icon": "✅",
      "input": [],
      "tasks": [
        "Hồ sơ chất lượng (đề cập tại Mục 8 Phần II trên đây ) Biên bảnnghi ệmthukh ối lượngcôngvi ệchoànthành t ương ứng vớigiai đoạnthànhtoán đã được đại"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "stepName": "diệnNhàth ầu, đạidi ện Tư vấngiámsátvà đạidi ệnChủ đầu tư ký, đóng dấu (kèmtheo B ảngchi ếttính khối lượng ) Bảngxác địnhgiátr ị khối lượngcôngvi ệchoànthànhtheo h ợp đồng đề nghị thanhtoáncóxác nhận của đại diện Chủ đầu tư và đại diện Nhà thầu Bảngxác địnhgiátr ị khối lượngcôngvi ệcphátsinhngoài h ợp đồng đề nghị thanhtoáncóxác nhận của đại diện Chủ đầu tư và đại diện Nhà thầu",
      "gate": "G14",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "diệnNhàth ầu, đạidi ện Tư vấngiámsátvà đạidi ệnChủ đầu tư ký, đóng dấu (kèmtheo B ảngchi ếttính khối lượng ) Bảngxác địnhgiátr ị khối lượngcôngvi ệchoànthànhtheo h ợp đồng đề nghị thanhtoáncóxác nhận của đại diện Chủ đầu tư và đại diện Nhà thầu Bảngxác địnhgiátr ị khối lượngcôngvi ệcphátsinhngoài h ợp đồng đề nghị thanhtoáncóxác nhận của đại diện Chủ đầu tư và đại diện Nhà thầu"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "stepName": "Hồ sơ quyết toán Hợp đồng (quyết toán A-B) Văn bản đề nghị quyếttoán c ủaNhàth ầukèmtheoBiên b ảngiaonh ận hồ sơ (liệtkêchiti ếtdanh m ục hồ sơ )",
      "gate": "G11",
      "icon": "📑",
      "input": [],
      "tasks": [
        "Hồ sơ quyết toán Hợp đồng (quyết toán A-B) Văn bản đề nghị quyếttoán c ủaNhàth ầukèmtheoBiên b ảngiaonh ận hồ sơ (liệtkêchiti ếtdanh m ục hồ sơ )"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Tài liệu công bố tiêu chuẩn áp dụng của Nhà sản xuất đối với sản phẩm, hàng hóa Chứngnh ận hợpquy,công b ố hợpquy,thôngbáoti ếpnh ận hồ sơ công bố hợpquy c ủa cơ quan",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Tài liệu công bố tiêu chuẩn áp dụng của Nhà sản xuất đối với sản phẩm, hàng hóa Chứngnh ận hợpquy,công b ố hợpquy,thôngbáoti ếpnh ận hồ sơ công bố hợpquy c ủa cơ quan"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "chuyênngành;ch ứngnh ận hợpchu ẩnvàcông b ố hợpchu ẩn(n ếucó)theoquy định củaLu ậtCh ất lượng sản phẩm hàng hóa",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "chuyênngành;ch ứngnh ận hợpchu ẩnvàcông b ố hợpchu ẩn(n ếucó)theoquy định củaLu ậtCh ất lượng sản phẩm hàng hóa"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Kết quả thí nghiệm vật liệu/kiểm định thiết bị Giấych ứngnh ậnxu ất xứ (CO) đối với vậtli ệu/thiết bị nhậpkh ẩu;Biên b ảngiaonh ậnhànghóa đối với hàng hóa trong nước",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Kết quả thí nghiệm vật liệu/kiểm định thiết bị Giấych ứngnh ậnxu ất xứ (CO) đối với vậtli ệu/thiết bị nhậpkh ẩu;Biên b ảngiaonh ậnhànghóa đối với hàng hóa trong nước"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Biên bản bàn giao hồ sơ thiết kế (bao gồm thiết kế bản vẽ thi công ) đã được phê duyệt cho Nhà thầu Biên bảnbàngiao h ồ sơ thiết kế; hồ sơ mờith ầu, hồ sơ dự thầu củaNhàth ầutrúngth ầu,Biên b ản thương thảo và Hợp đồng, phụ lục Hợp đồng cho Tư vấn giám sát",
      "gate": "G9",
      "icon": "📐",
      "input": [],
      "tasks": [
        "Biên bản bàn giao hồ sơ thiết kế (bao gồm thiết kế bản vẽ thi công ) đã được phê duyệt cho Nhà thầu Biên bảnbàngiao h ồ sơ thiết kế; hồ sơ mờith ầu, hồ sơ dự thầu củaNhàth ầutrúngth ầu,Biên b ản thương thảo và Hợp đồng, phụ lục Hợp đồng cho Tư vấn giám sát"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Báo cáo giám sát định kỳ/giai đoạn của Tư vấn giám sát Nghiệm thu bộ phận, giai đoạn hoàn thành (nếu có); nghiệm thu hoàn thành công trình để đưa vào sử dụng Cácthay đổithiết kế trongquátrìnhthicôngxây d ựngcông trình vàcác v ăn bảnthẩm định,phêduy ệt của cấp có thẩm quyền (lập danh mục kèm theo )",
      "gate": "G9",
      "icon": "📐",
      "input": [],
      "tasks": [
        "Báo cáo giám sát định kỳ/giai đoạn của Tư vấn giám sát Nghiệm thu bộ phận, giai đoạn hoàn thành (nếu có); nghiệm thu hoàn thành công trình để đưa vào sử dụng Cácthay đổithiết kế trongquátrìnhthicôngxây d ựngcông trình vàcác v ăn bảnthẩm định,phêduy ệt của cấp có thẩm quyền (lập danh mục kèm theo )"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Biên bản bàn giao mặt bằng, mốc trắc đạc cho Nhà thầu thi công, thể hiện phạm vi, tọa độ, cao độ Biệnphápthicôngdonhàth ầu lập (bao gồm cả biệnpháp b ảo vệ môitr ường,phòngch ốngcháy n ổ,",
      "gate": "G12",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Biên bản bàn giao mặt bằng, mốc trắc đạc cho Nhà thầu thi công, thể hiện phạm vi, tọa độ, cao độ Biệnphápthicôngdonhàth ầu lập (bao gồm cả biệnpháp b ảo vệ môitr ường,phòngch ốngcháy n ổ,"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Biên bản kiểm tra và Văn bản chấp thuận nghiệm thu về PCCC của cơ quan Công an Biên bảnki ểmtravà V ăn bảnchấp thuậnnghi ệmthu đưacông trình b ảo vệ môitr ườngvào s ử dụng của cơ quan QLNN về môi trường (nếu có) Biên bảnki ểmtravà V ăn bảnxác nhận củacác t ổ chức, cơ quanQLNNcóthẩmquy ền về antoàn v ận hành hệ thống thiết bị công trình, thiết bị công nghệ (nếu có)",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Biên bản kiểm tra và Văn bản chấp thuận nghiệm thu về PCCC của cơ quan Công an Biên bảnki ểmtravà V ăn bảnchấp thuậnnghi ệmthu đưacông trình b ảo vệ môitr ườngvào s ử dụng của cơ quan QLNN về môi trường (nếu có) Biên bảnki ểmtravà V ăn bảnxác nhận củacác t ổ chức, cơ quanQLNNcóthẩmquy ền về antoàn v ận hành hệ thống thiết bị công trình, thiết bị công nghệ (nếu có)"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Phụ lục các tồn tại cần sửa chữa, khắc phục (nếu có) sau khi đưa công trình vào khai thác sử dụng Các hồ sơ/văn bản/tàili ệukhácliênquantrongquátrìnhthicôngxây d ựng (lậpdanh m ụcchiti ếtkèm theo ) Biên bảnki ểmtravà V ăn bảnchấp thuậncông trình đủ điềuki ệnvào s ử dụng của cơ quan chuyên môn về xây dựng",
      "gate": "G11",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Phụ lục các tồn tại cần sửa chữa, khắc phục (nếu có) sau khi đưa công trình vào khai thác sử dụng Các hồ sơ/văn bản/tàili ệukhácliênquantrongquátrìnhthicôngxây d ựng (lậpdanh m ụcchiti ếtkèm theo ) Biên bảnki ểmtravà V ăn bảnchấp thuậncông trình đủ điềuki ệnvào s ử dụng của cơ quan chuyên môn về xây dựng"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Biên bản nghiệm thu bộ phận, giai đoạn hoàn thành của Chủ đầu tư Báo cáo c ủaChủ đầu tư gửi cơ quan chuyên môn về xây dựng để thựchi ệnki ểmtracôngtácnghi ệm thu theo quy định trong quá trình thi công Thôngbáo k ếtqu ả kiểmtra c ủa cơ quan chuyên môn về xây dựngtrongquátrìnhthicôngxây d ựng công trình",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Biên bản nghiệm thu bộ phận, giai đoạn hoàn thành của Chủ đầu tư Báo cáo c ủaChủ đầu tư gửi cơ quan chuyên môn về xây dựng để thựchi ệnki ểmtracôngtácnghi ệm thu theo quy định trong quá trình thi công Thôngbáo k ếtqu ả kiểmtra c ủa cơ quan chuyên môn về xây dựngtrongquátrìnhthicôngxây d ựng công trình"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Kết quả quan trắc công trình (nếu có), đo đạc trong quá trình thi công. Các kếtqu ả thínghi ệm đốich ứng,ki ểm địnhch ất lượngcông trình,thínghi ệmkhả năngch ịu lực kết cấu xây dựng (nếu có)",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Kết quả quan trắc công trình (nếu có), đo đạc trong quá trình thi công. Các kếtqu ả thínghi ệm đốich ứng,ki ểm địnhch ất lượngcông trình,thínghi ệmkhả năngch ịu lực kết cấu xây dựng (nếu có)"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "biệnpháp đảm bảoantoànchiti ết;bi ệnphápki ểmtra,ki ểmsoátch ất lượng vậtli ệu, sảnph ẩm, cấu kiện, thiết bị được sử dụng cho công trình ) đã được Chủ đầu tư chấp thuận Kếtqu ả thẩmtra c ủa tổ chức tư vấn đủ điềuki ện năng lực,phêduy ệt củaChủ đầu tưđố i vớibi ệnpháp",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "biệnpháp đảm bảoantoànchiti ết;bi ệnphápki ểmtra,ki ểmsoátch ất lượng vậtli ệu, sảnph ẩm, cấu kiện, thiết bị được sử dụng cho công trình ) đã được Chủ đầu tư chấp thuận Kếtqu ả thẩmtra c ủa tổ chức tư vấn đủ điềuki ện năng lực,phêduy ệt củaChủ đầu tưđố i vớibi ệnpháp"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "thicông đặcthù ( phá dỡ công trìnhxây d ựng đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, lợi ích cộng đồng; cần trục tháp; biện pháp thi công tầng hầm,… ) Kế hoạch tổ chứcthínghi ệm,ki ểmtra,ki ểm định,th ử nghiệm,ch ạyth ử,quantr ắc, đo đạccácthông s ố kỹ thuật của công trình được Chủ đầu tư chấp thuận",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Tiến độ thi công xây dựng, cung cấp và lắp đặt thiết bị do Nhà thầu lập, được Chủ đầu tư chấp thuận Kế hoạchki ểmtra,nghi ệmthucôngvi ệcxây d ựng,nghi ệmthugiai đoạnthicôngxây d ựngho ặc bộ",
      "gate": "G12",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Tiến độ thi công xây dựng, cung cấp và lắp đặt thiết bị do Nhà thầu lập, được Chủ đầu tư chấp thuận Kế hoạchki ểmtra,nghi ệmthucôngvi ệcxây d ựng,nghi ệmthugiai đoạnthicôngxây d ựngho ặc bộ"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "phận(h ạng mục)công trìnhxây d ựng,nghi ệmthuhoànthành h ạng mụccông trình,công trìnhxây dựng được Chủ đầu tư chấp thuận Kế hoạch tổng hợp về antoàn ( theoquy định tạiPh ụ lụcIIINgh ịđị nh số 06/2021/NĐ-CP );vi ệc bố trí Người thực hiện công tác quản lý an toàn lao động của Nhà thầu",
      "gate": "G12",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "phận(h ạng mục)công trìnhxây d ựng,nghi ệmthuhoànthành h ạng mụccông trình,công trìnhxây dựng được Chủ đầu tư chấp thuận Kế hoạch tổng hợp về antoàn ( theoquy định tạiPh ụ lụcIIINgh ịđị nh số 06/2021/NĐ-CP );vi ệc bố trí Người thực hiện công tác quản lý an toàn lao động của Nhà thầu"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Xác định vùng nguy hiểm Báo cáo về biệnpháp đảm bảoantoàn đến cơ quan chuyên môn về xây dựngtrongtr ường hợpthicông xây dựng công trình có vùng nguy hiểm ảnh hưởng lớn đến an toàn cộng đồng",
      "gate": "G12",
      "icon": "👷",
      "input": [],
      "tasks": [
        "Xác định vùng nguy hiểm Báo cáo về biệnpháp đảm bảoantoàn đến cơ quan chuyên môn về xây dựngtrongtr ường hợpthicông xây dựng công trình có vùng nguy hiểm ảnh hưởng lớn đến an toàn cộng đồng"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Bản vẽ gia công chế tạo (shop drawing) do nhà thầu lập đã được Chủ đầu tư phê duyệt Tờ trìnhphêduy ệt vậtli ệu/thiết bị (kèmtheocatalogue, m ẫu vậtli ệu)doNhàth ầutrình đã đượcCh ủ",
      "gate": "G12",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Bản vẽ gia công chế tạo (shop drawing) do nhà thầu lập đã được Chủ đầu tư phê duyệt Tờ trìnhphêduy ệt vậtli ệu/thiết bị (kèmtheocatalogue, m ẫu vậtli ệu)doNhàth ầutrình đã đượcCh ủ"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "đầu tư phêduy ệttr ướckhiNhàth ầuth ựchi ệnmua s ắm (đối với vậtli ệu/thiết bị chưacótrong H ợp đồng hoặc thay đổi so với Hợp đồng )",
      "gate": "G11",
      "icon": "📑",
      "input": [],
      "tasks": [
        "đầu tư phêduy ệttr ướckhiNhàth ầuth ựchi ệnmua s ắm (đối với vậtli ệu/thiết bị chưacótrong H ợp đồng hoặc thay đổi so với Hợp đồng )"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn thực hiện dự án",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "stepName": "Hồ sơ, quy trình quản lý chất lượng thi công (hệ thống quản lý chất lượng thi công ) của Nhà thầu Hồ sơ,quytrìnhgiámsátch ất lượngvànghi ệmthu ( hệ thốngqu ảnlých ất lượnggiámsát ) của Tư vấn giám sát Thôngbáo về ngàykh ởicôngxây d ựng đến cơ quanqu ảnlýnhà n ước về xây dựng tại địaph ươngvà cơ quan chuyên môn về xây dựng",
      "gate": "G12",
      "icon": "🤝",
      "input": [],
      "tasks": [
        "Hồ sơ, quy trình quản lý chất lượng thi công (hệ thống quản lý chất lượng thi công ) của Nhà thầu Hồ sơ,quytrìnhgiámsátch ất lượngvànghi ệmthu ( hệ thốngqu ảnlých ất lượnggiámsát ) của Tư vấn giám sát Thôngbáo về ngàykh ởicôngxây d ựng đến cơ quanqu ảnlýnhà n ước về xây dựng tại địaph ươngvà cơ quan chuyên môn về xây dựng"
      ],
      "output": [
        "Bộ hồ sơ tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn kết thúc dự án",
      "group": "Bàn giao công trình",
      "stepName": "Danh mục các thiết bị, phụ tùng, vật tư dự trữ thay thế được Tư vấn giám sát xác nhận Biên bảnbàngiaogi ữaNhàth ầuvàChủ đầu tư về bản vẽ hoàncông,quytrình h ướng dẫn vậnhành,",
      "gate": "G12",
      "icon": "📦",
      "input": [],
      "tasks": [
        "Danh mục các thiết bị, phụ tùng, vật tư dự trữ thay thế được Tư vấn giám sát xác nhận Biên bảnbàngiaogi ữaNhàth ầuvàChủ đầu tư về bản vẽ hoàncông,quytrình h ướng dẫn vậnhành,"
      ],
      "output": [
        "Biên bản / tài liệu xác nhận"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn kết thúc dự án",
      "group": "Bàn giao công trình",
      "stepName": "quytrình b ảotrìcông trình,danh m ụccácthi ết bị,ph ụ tùng, vật tư dự trữ thayth ế vàcáctàili ệu cần thiết khác có liên quan",
      "gate": "G16",
      "icon": "📦",
      "input": [],
      "tasks": [
        "quytrình b ảotrìcông trình,danh m ụccácthi ết bị,ph ụ tùng, vật tư dự trữ thayth ế vàcáctàili ệu cần thiết khác có liên quan"
      ],
      "output": [
        "Hồ sơ / sản phẩm đầu ra tương ứng"
      ],
    ...
    },
    {
      ...
      "stageName": "Giai đoạn kết thúc dự án",
      "group": "Kiểm toán",
      "stepName": "Báo cáo kết quả kiểm toán Báo cáo c ủaChủ đầu tư kèmcáctàili ệuliênquan về tìnhhìnhch ấphànhcácki ếnngh ị củaKi ểmtoán (nếu có)",
      "gate": "G15",
      "icon": "🔎",
      "input": [],
      "tasks": [
        "Báo cáo kết quả kiểm toán Báo cáo c ủaChủ đầu tư kèmcáctàili ệuliênquan về tìnhhìnhch ấphànhcácki ếnngh ị củaKi ểmtoán (nếu có)"
      ],
      "output": [
        "Báo cáo / kết quả xử lý tương ứng"
      ],
  ...
  "checklists": [
    ...
    },
    {
      ...
      "gate": "G7",
      "group": "Vốn bố trí cho dự án giai đoạn chuẩn bị đầu tư",
      "item": "I.5.2 - Quyết định/Thông báo bố trí vốn hằng năm Nhiệm vụ thiết kếđượ cCh ủđầ u tư phêduy ệt;cácý kiến củacác c ơ quanliênquan(n ếucó) v ề Nhiệm vụ thiết kế (liệt kê chi tiết)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
    ...
    },
    {
      ...
      "gate": "G4",
      "group": "Đánh giá tác động môi trường (ĐTM)",
      "item": "I.9.4 - Quyết định phê duyệt ĐTM Khảosátph ục vụ thiết kế cơ sở (cóth ể bao gồmkhảosát địahình,khảosát địach ấtcông trình, khảo sát hiện trạng công trình), tương ứng với mỗi loại khảo sát gồm:",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Quyết định đầu tư",
      "item": "I.11.2 - Báo cáo kết quả thẩm tra nếu có theo yêu cầu của cơ quan chuyên môn về xây dựng Văn bản ý kiến của cơ quanCông an v ề giải phápphòng cháy,chữa cháygiai đoạnthiết kế cơ sở (nếu có) (theo Luật PCCC năm 2024 bỏ thủ tục này, thực tế một số DA vẫn thực hiện xin ý kiến ) Các văn bảnthỏa thuận,xác nhận vềđấu nối hạ tầng kỹ thuật của dự án (gồm: cấp điện, cấp nước, thoát nước thải, đấu nối giao thông, các văn bản thỏa thuận về kết nối hạ tầng khác nếu có ):",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
    ...
    },
    {
      ...
      "gate": "G2",
      "group": "Quyết định đầu tư",
      "item": "I.11.9 - TKCS đã được đóng dấuthẩm định của cơ quanchuyênmôn v ề xây dựng; tổng mức đầu tư;danh m ục tiêu chuẩn áp dụng cho dự án )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư",
      "status": "unchecked",
      "critical": false,
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "item": "I.13.2 - Báo cáo kết quả thẩm tra nếu có theo yêu cầu của cơ quan chuyên môn về xây dựng Văn bản ý kiến của cơ quanCông an v ề giải phápphòng cháy,chữa cháygiai đoạnthiết kế cơ sở điều",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Cơ quan PCCC / Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "item": "I.13.3 - chỉnh(n ếucó) ( theoLu ậtPCCC n ăm2024 đã bỏ thủ tụcnày,tuynhiênth ực tế có một số DA vẫnth ực hiện xin ý kiến )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "item": "I.13.5 - Báo cáo thẩm định nội bộ của Chủ đầu tư về việc điều chỉnh dự án đầu tư xây dựng công trình Kếtqu ả thẩm định của cơ quanchuyênmôn v ề xây dựng (nếucótheoquy định tạikho ản 2 Điều19 Nghị định số 59/2021/NĐ-CP )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư",
      "status": "unchecked",
      "critical": false,
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "item": "I.13.6 - Kết quả thẩm định của cơ quan chuyên môn trực thuộc Người quyết định đầu tư BCNCKT điều chỉnh (trong đó bản vẽ thiết kế cơ sở điều chỉnh đã được đóng dấuthẩm định của cơ quan chuyên môn về xây dựng (nếu có) )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Quyết định đầu tư điều chỉnh (nếu có)",
      "item": "I.13.8 - Quyết định phê duyệt điều chỉnh dự án đầu tư xây dựng Cáctàili ệukháccóliênquantronggiai đoạnchu ẩn bịđầ u tư xây dựng(l ậpdanh m ụcchiti ết kèm theo)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư",
      "status": "unchecked",
      "critical": false,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.1.4 - Văn bản thông báo chấp thuận nghiệm thu kết quả khảo sát xây dựng. Thiết kế kỹ thuật(tr ường hợpthiết kế 03 bước)/thiết kế bản vẽ thicông(tr ường hợpthiết kế 02 bước) và dự toán xây dựng công trình tương ứng",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.2.2 - Tờ trình thẩm định Báo cáo k ếtqu ả thẩmtrathiết kế (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, l ợiích c ộng đồng )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.2.5 - Kết quả thẩm định thiết kế PCCC của cơ quan Công an Ýki ến của cơ quanchuyênmôn v ề bảo vệ môitr ường đối vớicông trình,thi ết bị xử lý nướcth ải tại chỗ, thiết bị thu gom và lưu chứa tạm thời chất thải (nếu có)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Cơ quan PCCC / Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.2.11 - Kết quả thẩm định dự toán của Chủ đầu tư/Người quyết định đầu tư Hồ sơ thiết kế đãch ỉnh sửa,hoànthi ệnsauthẩm định (gồmthuy ếtminhthiết kế, bảntính;các b ản vẽ",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.2.12 - thiết kế đã được đóng dấuthẩm định của cơ quanchuyênmôn v ề xây dựngch ỉ dẫn kỹ thuậtvàquy trình bảo trì công trình xây dựng ), có kèm theo danh mục bản vẽ",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.3 - Thiết kế bản vẽ thi công (trường hợp thiết kế 03 bước) và dự toán xây dựng công trình tương ứng Báo cáo k ếtqu ả thẩmtrathiết kế (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, l ợiích c ộng đồng )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.3.1 - Báo cáo kết quả thẩm tra dự toán Hồ sơ thiết kế đãch ỉnh sửa,hoànthi ệnsauthẩmtravà đã được đóng dấuthẩmtra,Ch ủđầ u tư phê duyệt; có kèm theo danh mục bản vẽ",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4 - Thiết kế, dự toán điều chỉnh (nếu có) Tờ trình thẩm định (trường hợpcóthay đổi vềđị ach ấtcông trình, t ảitr ọngthiết kế,gi ảipháp k ết cấu,",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4.1 - vậtli ệu của kết cấuch ịu lực,bi ệnpháp t ổ chứcthicông ảnh hưởng đếnantoànch ịu lực củacông trình ) Báo cáo k ếtqu ả thẩmtrathiết kế điều chỉnh (đối vớicông trìnhxây d ựng ảnh hưởng lớn đếnantoàn, lợi ích cộng đồng)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4.4 - Kết quả thẩm định thiết kế PCCC điều chỉnh của cơ quan Công an (nếu có) Ýki ến của cơ quanchuyênmôn v ề bảo vệ môitr ường đối vớicông trình,thi ết bị xử lý nướcth ải tại chỗ, thiết bị thu gom và lưu chứa tạm thời chất thải (nếu có)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Cơ quan PCCC / Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G5",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4.10 - Kết quả thẩm định dự toán điều chỉnh của Chủ đầu tư/Người quyết định đầu tư Hồ sơ thiết kế điều chỉnh đãch ỉnh sửa,hoànthi ệnsauthẩm định (gồmthuy ếtminhthiết kế, bảntính;",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4.11 - các bản vẽ thiết kế đã được đóng dấuthẩm định của cơ quanchuyênmôn v ề xây dựng;ch ỉ dẫn kỹ thuật và quy trình bảo trì công trình xây dựng ), có kèm theo danh mục bản vẽ",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4.12 - Hồ sơ dự toán điều chỉnh đã chỉnh sửa, hoàn thiện sau thẩm định Chấpthu ận củaNg ườiquy ết định đầu tư (trường hợpvi ệc điều chỉnhlàm v ượt dự toán đãphêduy ệt",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G2",
      "group": "Khảo sát, thiết kế và dự toán xây dựng công trình",
      "item": "II.5.4.13 - nhưngkhông v ượt tổng mức đầu tư )/Báo cáo c ủaCh ủđầ u tư (trường hợpvi ệc điều chỉnhkhông v ượt dự toán đã phê duyệt nhưng làm thay đổi cơ cấu các khoản mục chi phí trong tổng mức đầu tư )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G10",
      "group": "Lựa chọn nhà thầu",
      "item": "II.6.1 - Chỉ định thầu rút gọn Dự toángóith ầu đượcCh ủđầ u tư xác định (nếucótrongtr ường hợp đãcó d ự toánxây d ựngcông trình ) Văn bản đề nghị thamgiagóith ầu củaNhàth ầu (kèmtheotàili ệuch ứngminh điềuki ện năng lực của tổ chức và cá nhân theo quy định )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
    ...
    },
    {
      ...
      "gate": "G10",
      "group": "Lựa chọn nhà thầu",
      "item": "II.6.2 - Chỉ định thầu thông thường Dự toángóith ầu đượcCh ủđầ u tư xác định (nếucótrongtr ường hợp đãcó d ự toánxây d ựngcông trình )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng / Tổ thẩm định đấu thầu",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G10",
      "group": "Lựa chọn nhà thầu",
      "item": "II.6.2.6 - Văn bản gửi Nhà thầu đề nghị lập Hồ sơ đề xuất Hồ sơđề xuất củaNhàth ầu (bao gồm cả tàili ệuch ứngminh điềuki ện năng lực của tổ chứcvàcá nhân theo quy định )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu",
      "status": "unchecked",
      "critical": false,
    ...
    },
    {
      ...
      "gate": "G10",
      "group": "Lựa chọn nhà thầu",
      "item": "II.6.3.4 - Tài liệu đăng tải thông tin mời thầu Pháthành h ồ sơ mờith ầu(Danhsáchho ặcbiên b ảngiaonh ận,phi ếuthucácnhàth ầumua h ồ sơ mời thầu đến trước thời điểm đóng thầu)",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu",
      "status": "unchecked",
      "critical": false,
    ...
    },
    {
      ...
      "gate": "G10",
      "group": "Lựa chọn nhà thầu",
      "item": "II.6.3.15 - Quyết định phê duyệt/Văn bản chấp thuận danh sách nhà thầu đáp ứng về kỹ thuật. Thôngbáodanhsáchnhàth ầu đáp ứng kỹ thuật tới tất cả cácnhàth ầu, mờinhàth ầu đến mở hồ sơđề xuất tài chính.",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu",
      "status": "unchecked",
      "critical": false,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "item": "II.7.1 - Hợp đồng CácPh ụ lục Hợp đồng nếucó ( điều chỉnh, bổ sungkh ối lượng, nộidungcôngvi ệc;ti ến độ;giá Hợp đồng; các điều khoản Hợp đồng)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư / Người quyết định đầu tư khi vượt thẩm quyền",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "item": "II.7.2 - Văn bản của Chủ đầu tư giao Nhà thầu thực hiện bổ sung nội dung công việc Văn bản đề xuất củaNhàth ầu về tiến độ,giá H ợp đồng điều chỉnh (kèmtheobi ểugiáchiti ết đề xuất, tài liệu chứng minh đơn giá đề xuất )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "item": "II.7.2.2 - Biên bản thương thảo điều chỉnh Hợp đồng Văn bảnchấp thuận củaNg ườiquy ết định đầu tư trongtr ường hợp:(i) B ổ sungkh ối lượngphátsinh",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư / Người quyết định đầu tư khi vượt thẩm quyền",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Hợp đồng, các Phụ lục Hợp đồng trong quá trình thực hiện",
      "item": "II.7.2.4 - ngoàiph ạmvicôngvi ệc củagóith ầu;ho ặc(ii) V ượtgiágóith ầuho ặc dự toángóith ầu đượcphê duyệt; hoặc (iii) Trường hợp điều chỉnh tiến độ làm kéo dài tiến độ thực hiện hợp đồng",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.8.2 - Các công việc tư vấn khác Biên bảnbàngiao s ảnph ẩm tư vấn(h ồ sơ thiết kế, dự toán/báo cáo k ếtqu ả thẩmtra/Báo cáocôngtác giám sát,…)",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.b - Biên bản bàn giao hồ sơ thiết kế (bao gồm thiết kế bản vẽ thi công ) đã được phê duyệt cho Nhà thầu Biên bảnbàngiao h ồ sơ thiết kế; hồ sơ mờith ầu, hồ sơ dự thầu củaNhàth ầutrúngth ầu,Biên b ản thương thảo và Hợp đồng, phụ lục Hợp đồng cho Tư vấn giám sát",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng / Tổ thẩm định đấu thầu",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.c - Biên bản bàn giao mặt bằng, mốc trắc đạc cho Nhà thầu thi công, thể hiện phạm vi, tọa độ, cao độ Biệnphápthicôngdonhàth ầu lập (bao gồm cả biệnpháp b ảo vệ môitr ường,phòngch ốngcháy n ổ,",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.e - biệnpháp đảm bảoantoànchiti ết;bi ệnphápki ểmtra,ki ểmsoátch ất lượng vậtli ệu, sảnph ẩm, cấu kiện, thiết bị được sử dụng cho công trình ) đã được Chủ đầu tư chấp thuận Kếtqu ả thẩmtra c ủa tổ chức tư vấn đủ điềuki ện năng lực,phêduy ệt củaCh ủđầ u tưđố i vớibi ệnpháp",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.g - Tiến độ thi công xây dựng, cung cấp và lắp đặt thiết bị do Nhà thầu lập, được Chủ đầu tư chấp thuận Kế hoạchki ểmtra,nghi ệmthucôngvi ệcxây d ựng,nghi ệmthugiai đoạnthicôngxây d ựngho ặc bộ",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.i - phận(h ạng mục)công trìnhxây d ựng,nghi ệmthuhoànthành h ạng mụccông trình,công trìnhxây dựng được Chủ đầu tư chấp thuận Kế hoạch tổng hợp về antoàn ( theoquy định tạiPh ụ lụcIIINgh ịđị nh số 06/2021/NĐ-CP );vi ệc bố trí Người thực hiện công tác quản lý an toàn lao động của Nhà thầu",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.j - Xác định vùng nguy hiểm Báo cáo v ề biệnpháp đảm bảoantoàn đến cơ quanchuyênmôn v ề xây dựngtrongtr ường hợpthicông xây dựng công trình có vùng nguy hiểm ảnh hưởng lớn đến an toàn cộng đồng",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.o - Bản vẽ gia công chế tạo (shop drawing) do nhà thầu lập đã được Chủ đầu tư phê duyệt Tờ trìnhphêduy ệt vậtli ệu/thiết bị (kèmtheocatalogue, m ẫu vậtli ệu)doNhàth ầutrình đã đượcCh ủ",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.p - đầu tư phêduy ệttr ướckhiNhàth ầuth ựchi ệnmua s ắm (đối với vậtli ệu/thiết bị chưacótrong H ợp đồng hoặc thay đổi so với Hợp đồng )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.s - Hồ sơ, quy trình quản lý chất lượng thi công (hệ thống quản lý chất lượng thi công ) của Nhà thầu Hồ sơ,quytrìnhgiámsátch ất lượngvànghi ệmthu ( hệ thốngqu ảnlých ất lượnggiámsát ) của Tư vấn giám sát Thôngbáo v ề ngàykh ởicôngxây d ựng đến cơ quanqu ảnlýnhà n ước về xây dựng tại địaph ươngvà cơ quan chuyên môn về xây dựng",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.a3 - Tài liệu công bố tiêu chuẩn áp dụng của Nhà sản xuất đối với sản phẩm, hàng hóa Chứngnh ận hợpquy,công b ố hợpquy,thôngbáoti ếpnh ận hồ sơ công bố hợpquy c ủa cơ quan",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.a4 - chuyênngành;ch ứngnh ận hợpchu ẩnvàcông b ố hợpchu ẩn(n ếucó)theoquy định củaLu ậtCh ất lượng sản phẩm hàng hóa",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.a5 - Kết quả thí nghiệm vật liệu/kiểm định thiết bị Giấych ứngnh ậnxu ất xứ (CO) đối với vậtli ệu/thiết bị nhậpkh ẩu;Biên b ảngiaonh ậnhànghóa đối với hàng hóa trong nước",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G9",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.b7 - Báo cáo giám sát định kỳ/giai đoạn của Tư vấn giám sát Nghiệm thu bộ phận, giai đoạn hoàn thành (nếu có); nghiệm thu hoàn thành công trình để đưa vào sử dụng Cácthay đổithiết kế trongquátrìnhthicôngxây d ựngcông trình vàcác v ăn bảnthẩm định,phêduy ệt của cấp có thẩm quyền (lập danh mục kèm theo )",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Sở Xây dựng / Sở chuyên ngành quản lý công trình xây dựng / Tư vấn giám sát / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.c4 - Biên bản nghiệm thu bộ phận, giai đoạn hoàn thành của Chủ đầu tư Báo cáo c ủaCh ủđầ u tư gửi cơ quanchuyênmôn v ề xây dựng để thựchi ệnki ểmtracôngtácnghi ệm thu theo quy định trong quá trình thi công Thôngbáo k ếtqu ả kiểmtra c ủa cơ quanchuyênmôn v ề xây dựngtrongquátrìnhthicôngxây d ựng công trình",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.c9 - Kết quả quan trắc công trình (nếu có), đo đạc trong quá trình thi công. Các kếtqu ả thínghi ệm đốich ứng,ki ểm địnhch ất lượngcông trình,thínghi ệmkhả năngch ịu lực kết cấu xây dựng (nếu có)",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.c20 - Biên bản kiểm tra và Văn bản chấp thuận nghiệm thu về PCCC của cơ quan Công an Biên bảnki ểmtravà V ăn bảnchấp thuậnnghi ệmthu đưacông trình b ảo vệ môitr ườngvào s ử dụng của cơ quan QLNN về môi trường (nếu có) Biên bảnki ểmtravà V ăn bảnxác nhận củacác t ổ chức, cơ quanQLNNcóthẩmquy ền về antoàn v ận hành hệ thống thiết bị công trình, thiết bị công nghệ (nếu có)",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Hồ sơ chất lượng (Hồ sơ thi công - nghiệm thu)",
      "item": "II.c28 - Phụ lục các tồn tại cần sửa chữa, khắc phục (nếu có) sau khi đưa công trình vào khai thác sử dụng Các hồ sơ/văn bản/tàili ệukhácliênquantrongquátrìnhthicôngxây d ựng (lậpdanh m ụcchiti ếtkèm theo ) Biên bảnki ểmtravà V ăn bảnchấp thuậncông trình đủ điềuki ệnvào s ử dụng của cơ quanchuyênmôn về xây dựng",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Nhà thầu",
      "checkedBy": "Tư vấn giám sát / Chủ đầu tư / Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G14",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9 - Công tác tạm ứng, thanh toán, quyết toán Bảng tổng hợp lũy kế giátr ị giảingân củatoàn b ộ Dự án từngthángtheo t ừngkho ản mụcchiphí/gói thầu/phần việc",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán / Cơ quan tài chính / Tổ thẩm tra quyết toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9.1 - Hồ sơ tạm ứng (từng đợt) Văn bảnchấp thuận của cấpcóthẩmquy ền về việcchophép t ạm ứng vượtquá30%giátr ị hợp đồng (bao gồm cả dự phòng nếu có)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán / Cơ quan tài chính / Tổ thẩm tra quyết toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9.2.5 - Bảo lãnh thực hiện Hợp đồng Văn bảncam k ết củaNgânhàng v ề việcch ỉđượ cphépkh ấutr ừ vàthanhtoánchocáccôngvi ệcliên quan đến dự án (nếu Hợp đồng có quy định )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán / Cơ quan tài chính / Tổ thẩm tra quyết toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G14",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9.3 - Hồ sơ thanh toán (từng đợt) Văn bản đề nghị thanhtoán c ủaNhàth ầukèmtheoBiên b ảngiaonh ận hồ sơ (liệtkêchiti ếtdanh m ục hồ sơ )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán / Cơ quan tài chính / Tổ thẩm tra quyết toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9.3.1 - Hồ sơ chất lượng (đề cập tại Mục 8 Phần II trên đây ) Biên bảnnghi ệmthukh ối lượngcôngvi ệchoànthành t ương ứng vớigiai đoạnthànhtoán đã được đại",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán / Cơ quan tài chính / Tổ thẩm tra quyết toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G14",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9.3.3 - diệnNhàth ầu, đạidi ện Tư vấngiámsátvà đạidi ệnCh ủđầ u tư ký, đóng dấu (kèmtheo B ảngchi ếttính khối lượng ) Bảngxác địnhgiátr ị khối lượngcôngvi ệchoànthànhtheo h ợp đồng đề nghị thanhtoáncóxác nhận của đại diện Chủ đầu tư và đại diện Nhà thầu Bảngxác địnhgiátr ị khối lượngcôngvi ệcphátsinhngoài h ợp đồng đề nghị thanhtoáncóxác nhận của đại diện Chủ đầu tư và đại diện Nhà thầu",
      "preparedBy": "Chủ đầu tư / Ban QLDA / Bên mời thầu",
      "checkedBy": "Tổ thẩm định đấu thầu / Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G11",
      "group": "Công tác tạm ứng, thanh toán, quyết toán",
      "item": "II.9.4 - Hồ sơ quyết toán Hợp đồng (quyết toán A-B) Văn bản đề nghị quyếttoán c ủaNhàth ầukèmtheoBiên b ảngiaonh ận hồ sơ (liệtkêchiti ếtdanh m ục hồ sơ )",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Kho bạc Nhà nước / Cơ quan kiểm soát thanh toán / Cơ quan tài chính / Tổ thẩm tra quyết toán",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G12",
      "group": "Bàn giao công trình",
      "item": "III.1.1 - Danh mục các thiết bị, phụ tùng, vật tư dự trữ thay thế được Tư vấn giám sát xác nhận Biên bảnbàngiaogi ữaNhàth ầuvàCh ủđầ u tư về bản vẽ hoàncông,quytrình h ướng dẫn vậnhành,",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G16",
      "group": "Bàn giao công trình",
      "item": "III.1.2 - quytrình b ảotrìcông trình,danh m ụccácthi ết bị,ph ụ tùng, vật tư dự trữ thayth ế vàcáctàili ệu cần thiết khác có liên quan",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Chủ đầu tư",
      "status": "unchecked",
      "critical": true,
    ...
    },
    {
      ...
      "gate": "G15",
      "group": "Kiểm toán",
      "item": "III.3.4 - Báo cáo kết quả kiểm toán Báo cáo c ủaCh ủđầ u tư kèmcáctàili ệuliênquan v ề tìnhhìnhch ấphànhcácki ếnngh ị củaKi ểmtoán (nếu có)",
      "preparedBy": "Chủ đầu tư / Ban QLDA",
      "checkedBy": "Cơ quan tài chính / Tổ thẩm tra quyết toán / Kiểm toán nếu có",
      "status": "unchecked",
      "critical": false,
